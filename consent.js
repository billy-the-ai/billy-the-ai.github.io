...
(function () {
  ...
  var CSS = [
    ...
    "background:var(--card,var(--surface,var(--panel,#ffffff)));color:var(--ink,var(--text,#14213d));",
    "border:1px solid var(--line,rgba(20,33,61,.12));border-radius:12px;padding:18px;",
    ...
    ".billy-consent p{margin:0 0 14px;font-size:14px;line-height:1.5;color:var(--muted,#56627a)}",
    ".billy-consent b{color:var(--ink,var(--text,#14213d));font-weight:700}",
    ...
    ".billy-consent__accept{background:var(--accent,var(--amber,#2350c8));color:#ffffff}",
    ".billy-consent__accept:hover{filter:brightness(1.06)}",
    ".billy-consent__decline{background:transparent;color:var(--ink,var(--text,#14213d));border-color:var(--line,rgba(20,33,61,.12))}",
    ".billy-consent__decline:hover{border-color:var(--muted,#56627a)}",
    ".billy-consent__manage{background:none;color:var(--muted,#56627a);padding:8px 4px}",
    ".billy-consent__manage:hover{color:var(--ink,var(--text,#14213d))}",
    ".billy-consent button:focus-visible{outline:2px solid var(--accent,var(--amber,#2350c8));outline-offset:2px}",
    ".billy-consent__detail{margin:4px 0 14px;border-top:1px solid var(--line,rgba(20,33,61,.12));padding-top:12px}",
    ".billy-consent__item{display:flex;gap:10px;align-items:flex-start;padding:8px 0}",
    ".billy-consent__item small{display:block;color:var(--muted,#56627a);font-size:13px;line-height:1.5;margin-top:2px}",
    ".billy-consent__item strong{font-size:14px}",
    ".billy-consent__item input{margin-top:3px;width:16px;height:16px;accent-color:var(--accent,var(--amber,#2350c8));flex:none}",
